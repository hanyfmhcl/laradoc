            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                ...
                @can('member_access')
                    <li class="items-center">
                        ...
                        <ul class="ml-4 subnav hidden">
                            @can('members_management_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/members-managements*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.members-managements.index") }}">
                ...
                @endcan
                @can('documents_management_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/documents*")||request()->is("admin/docs*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
                            <i class="fa-fw fas c-sidebar-nav-icon fa-cogs">
                            </i>
                            {{ trans('cruds.documentsManagement.title') }}
                        </a>
                        <ul class="ml-4 subnav hidden">
                            @can('document_access')
                                <li class="items-center">
                            ...
                            @can('doc_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/docs*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.docs.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fas fa-cogs">
                                        </i>
