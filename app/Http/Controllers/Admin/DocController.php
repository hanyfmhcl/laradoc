...
class DocController extends Controller
{
    ...
    {
        abort_if(Gate::denies('doc_create'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    {
        abort_if(Gate::denies('doc_edit'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    {
        abort_if(Gate::none(['doc_create', 'doc_edit']), Response::HTTP_FORBIDDEN, '403 Forbidden');
